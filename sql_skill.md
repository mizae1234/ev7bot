...
**เงื่อนไขการเปิดใช้งานปุ่ม "ปิดเคส"** (ปุ่มจะถูก disable เมื่อไม่ผ่านเงื่อนไข):
- ต้องมีใบงานที่สถานะ `GARAGE_COMPLETE` หรือ `READY_PICKUP_MAINTENANCE` อย่างน้อย 1 ใบ
- ห้ามมีใบงานที่สถานะ `WAITING_FOR_MAINTENANCE` หรือ `IN_MAINTENANCE` ค้างอยู่ (ใบที่ยังเข้าซ่อมหรือดำเนินการซ่อมอยู่ต้องดำเนินการให้เสร็จก่อน)
- ใบงานที่สถานะ `STILL_WORK` (รถยังขับใช้งานได้) **ไม่บล็อค**การปิดเคส เนื่องจากเป็นเหตุการณ์แยกต่างหากที่ยังไม่ต้องเข้าซ่อม
