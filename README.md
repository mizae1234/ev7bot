...
### 5. 📍 ประวัติการเคลื่อนย้ายรถ (`/vehicle-movement`)
- รวบรวมบันทึกการเคลื่อนย้ายรถและเปลี่ยนสถานที่จอดจากทุกจุดในระบบ
- กรองตามประเภท: ย้ายสถานที่ (`LOCATION_CHANGE`), ยึดคืนรถ (`REPOSSESS`), ตรวจรับคืน (`RETURN`)
- ส่งออกรายงาน Excel และมี SQL View (`dbo.View_VehicleMovementLog`) สำหรับ Butter AI Chatbot
